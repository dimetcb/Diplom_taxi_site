...
<html lang="ru">
  <head>
    ...
    />
    <script
      src="https://kit.fontawesome.com/eb17427400.js"
      crossorigin="anonymous"
    ></script>
  ...
  <body>
    ...
    <header>
      <div class="container-fluide py-3">
        <div class="row justify-content-between align-items-sm-center">
          ...
          <div class="col-lg-3 col-1">
            <strong class="font-weight-bolder text-left"
              >Аренда автомобилей такси</strong
            ><br />
            <strong class="font-weight-lighter"
              >Выгодные и честные условия</strong
            >
          </div>
      ...
      <nav class="navbar sticky-top navbar-expand-xl navbar-dark bg-warning">
        <img
          src="/img/favicon_package_v0.16(2)/android-chrome-192x192.png"
          width="30"
          height="30"
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            <a
              class="nav-link active mr-5 text-dark font-weight-normal"
              href="/index.php"
              >Главная <span class="sr-only">(текущая)</span></a
            >
            ...
            <a
              class="nav-link mr-5 text-dark font-weight-normal"
              href="/about.html"
              >О компании</a
            >
            <a
            ...
            <a
              class="nav-link mr-5 text-dark font-weight-normal"
              href="/reg.html"
              ><i class="fa-solid fa-user"></i> Личный кабинет</a
            >
          </div>
        </div>
      </nav>
    ...
    <div class="container-fluid content">
      <div class="container text-center title-info">
        ...
        <div
          class="title-info__list row align-items-center py-3 font-weight-bolder"
        >
          <div class="col-md-3 title-info font-weight-bolder">
            <div class="col">
              <img
                class="img-responsive"
                src="/img/icons8-проверено-16.png"
                alt="marks"
              />
              Удобный вывод денег
            </div>
    ...
    <div class="container">
      <div class="category">
        ...
        <div class="row justify-content-center">
          <div
            class="col-mb-6 px-5 category-card-container d-flex justify-content-end"
          >
            <div class="card" style="width: 18rem">
              ...
              <a class="btn btn-primary" href="#contacts-info" role="button"
                >Узнать подробнее</a
              >
            </div>
          </div>
      ...
      <div class="container p-5">
        ...
        <div class="row-list row text-center">
          <div class="col-md-4 col-sm-4 utp-list__item-container">
            <div
              class="col-list__item js-constructor-btn"
              data-name="Узнать подробнее о новых автомобилях"
              data-title="Узнать подробнее о новых автомобилях"
            >
              <img
                class="img-responsive"
                class="utp-list__item-img"
                src="/img/icons8-такси-96.png"
                alt=""
              />
          ...
          <div class="col-md-4 col-sm-4 utp-list__item-container">
            <div
              class="utp-list__item js-constructor-btn"
              data-name="Узнать подробнее об экономии"
              data-title="Узнать подробнее об экономии"
            >
              <img
                class="img-responsive"
                class="utp-list__item-img"
                src="/img/icons8-деньги-ваши-96.png"
                alt=""
              />
          ...
          <div class="col-md-4 col-sm-4 utp-list__item-container">
            <div
              class="utp-list__item js-constructor-btn"
              data-name="Узнать подробнее об экономии"
              data-title="Узнать подробнее о поддержке"
            >
              <img
                class="img-responsive"
                class="utp-list__item-img"
                src="/img/icons8-человек-с-щитом-96.png"
                alt=""
              />
            ...
            <form action="">
              ...
              <div class="col-md-2 mb-2" id="map">
                <script
                  ...
                  charset="utf-8"
                  async
                  src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A653e9d0cb8c0a59b44e83a1fab8e7ab89503092e243f707a87ee21f09f22bf11&amp;width=100%&amp;height=50vmin&amp;lang=ru_RU&amp;scroll=true"
                ></script>
              </div>
            </form>
          </div>
